...
postgresql_password_root="$3"
postgresql_persistence_size="$4"
...
cat<<EOF
  ...
  image:
    registry: docker.io
    repository: disrupticallc/postgresql
    tag: test
  ...
  replication:
    ...
    applicationName: site_db

  ## PostgreSQL admin password (used when "postgresqlUsername" is not "postgres")
  ## ref: https://github.com/bitnami/bitnami-docker-postgresql/blob/master/README.md#creating-a-database-user-on-first-run (see note!)
  postgresqlPostgresPassword: $postgresql_password_root
